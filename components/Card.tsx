...
export default function Card({ id, tools, prompts, datasets, data }: CardsProp) {
  ...
  return (
    <div key={id} className="w-[20.5rem] h-64 p-6 mt-3 border border-[--dark-bg] dark:border-[--light-bg]  rounded-3xl flex flex-col m-3 text-[--dark-bg] dark:text-[--light-bg]">
      ...
      {tools || datasets ? (
        <div className="mt-8">
          <a className="font-bold p-1 text-xs border py-[8px] px-4 hover:bg-[--primary-color] border-[--dark-bg] dark:border-[--light-bg] rounded-3xl" href={url} target="_blank">
            GO TO SITE
          </a>
        </div>
      ) : (
